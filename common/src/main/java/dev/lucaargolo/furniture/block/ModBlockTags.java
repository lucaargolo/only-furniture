...
public class ModBlockTags {
    ...
    public static TagKey<Block> CONNECTING_KITCHEN_COUNTER = create("connecting_kitchen_counter");
    public static TagKey<Block> TOP_FOR_KITCHEN_COUNTER = create("top_for_kitchen_counter");
