...
public class ModBlocks {
    ...
    public static final Map<WoodType, ModBlockRegistry.BlockEntry<WoodSeatFurnitureBlock>> CHAIR_MAP = registerForWoodSeat("chair", WoodBlock::getPlanks, WoodSeatFurnitureBlock::new, new Vec3(0.0, 0.4375, 0.0), ModBlockShapes.CHAIR, BlockTags.MINEABLE_WITH_AXE);
    ...
    public static final Map<WoodType, ModBlockRegistry.BlockEntry<WoodSeatFurnitureBlock>> SMALL_STOOL_MAP = registerForWoodSeat("small_stool", WoodBlock::getPlanks, WoodSeatFurnitureBlock::new, new Vec3(0.0, 0.25, 0.0), ModBlockShapes.SMALL_STOOL, BlockTags.MINEABLE_WITH_AXE);
    ...
    public static final Map<WoodType, ModBlockRegistry.BlockEntry<WoodSeatFurnitureBlock>> PICNIC_BENCH_MAP = registerForWood("picnic_bench", WoodBlock::getPlanks, (base, wood, shapes) -> {
    ...
    public static ModBlockRegistry.BlockEntry<MetalLampBlock> LAMP_POST = REGISTRY.register("cast_iron_lamp_post", () -> new MetalLampBlock(MetalBlock.MetalType.CAST_IRON, ModBlockShapes.LAMP_POST), BlockTags.NEEDS_STONE_TOOL, BlockTags.MINEABLE_WITH_PICKAXE);
    public static ModBlockRegistry.BlockEntry<MetalLampBlock> DUAL_LAMP_POST = REGISTRY.register("cast_iron_dual_lamp_post", () -> new MetalLampBlock(MetalBlock.MetalType.CAST_IRON, ModBlockShapes.DUAL_LAMP_POST), BlockTags.NEEDS_STONE_TOOL, BlockTags.MINEABLE_WITH_PICKAXE);
    public static ModBlockRegistry.BlockEntry<MetalLampBlock> TRIPLE_LAMP_POST = REGISTRY.register("cast_iron_triple_lamp_post", () -> new MetalLampBlock(MetalBlock.MetalType.CAST_IRON, ModBlockShapes.TRIPLE_LAMP_POST), BlockTags.NEEDS_STONE_TOOL, BlockTags.MINEABLE_WITH_PICKAXE);
    ...
    public static ModBlockRegistry.BlockEntry<KitchenSinkBlock> IRON_KITCHEN_SINK = REGISTRY.register("iron_kitchen_sink", () -> new KitchenSinkBlock.Metal(MetalBlock.MetalType.IRON), ModBlockTags.TOP_FOR_KITCHEN_COUNTER, BlockTags.NEEDS_STONE_TOOL, BlockTags.MINEABLE_WITH_PICKAXE);
    public static ModBlockRegistry.BlockEntry<KitchenSinkBlock> CAST_IRON_KITCHEN_SINK = REGISTRY.register("cast_iron_kitchen_sink", () -> new KitchenSinkBlock.Metal(MetalBlock.MetalType.CAST_IRON), ModBlockTags.TOP_FOR_KITCHEN_COUNTER, BlockTags.NEEDS_STONE_TOOL, BlockTags.MINEABLE_WITH_PICKAXE);
    ...
    public static ModBlockRegistry.BlockEntry<KitchenSinkBlock> QUARTZ_KITCHEN_SINK = REGISTRY.register("quartz_block_kitchen_sink", () -> new KitchenSinkBlock.Stone(StoneBlock.StoneType.QUARTZ_BLOCK), ModBlockTags.TOP_FOR_KITCHEN_COUNTER, BlockTags.MINEABLE_WITH_PICKAXE);

    public static ModBlockRegistry.BlockEntry<FurnitureBlock> FRIDGE = REGISTRY.register("fridge", () -> new FurnitureBlock(Blocks.IRON_BLOCK, ModBlockShapes.FRIDGE), BlockTags.NEEDS_STONE_TOOL, BlockTags.MINEABLE_WITH_PICKAXE);
    public static ModBlockRegistry.BlockEntry<FurnitureBlock> BIG_FRIDGE = REGISTRY.register("big_fridge", () -> new FurnitureBlock(Blocks.IRON_BLOCK, ModBlockShapes.BIG_FRIDGE), BlockTags.NEEDS_STONE_TOOL, BlockTags.MINEABLE_WITH_PICKAXE);

    public static ModBlockRegistry.BlockEntry<FurnitureBlock> STOVE = REGISTRY.register("stove", () -> new FurnitureBlock(Blocks.IRON_BLOCK, ModBlockShapes.STOVE), BlockTags.NEEDS_STONE_TOOL, BlockTags.MINEABLE_WITH_PICKAXE);
    ...
    public static ModBlockRegistry.BlockEntry<MetalLampBlock.Wall> WALL_LAMP = REGISTRY.register("cast_iron_wall_lamp", () -> new MetalLampBlock.Wall(MetalBlock.MetalType.CAST_IRON, ModBlockShapes.WALL_LAMP), BlockTags.NEEDS_STONE_TOOL, BlockTags.MINEABLE_WITH_PICKAXE);

    public static ModBlockRegistry.BlockEntry<PlantableBlock> PLANT_POT = REGISTRY.register("plant_pot", () -> new PlantableBlock(Blocks.FLOWER_POT, ModBlockShapes.FLOWER_POT));
    ...
    private static <T extends Block> Map<WoodType, ModBlockRegistry.BlockEntry<T>> registerForHedge(String path, Function<WoodType, Optional<Block>> baseGetter, Function<WoodType, ModColorProvider.Block> blockColorGetter, QuadFunction<Block, TagKey<Block>, WoodType, Float, T> furnitureConstructor, float size, TagKey<?>... tags) {
    ...
    private static <T extends Block> Map<WoodType, ModBlockRegistry.BlockEntry<T>> registerForWood(String path, Function<WoodType, Optional<Block>> baseGetter, Function<WoodType, ModColorProvider.Block> blockColorGetter, TriFunction<Block, WoodType, VoxelShape[], T> furnitureConstructor, VoxelShape[] shapes, TagKey<?>... tags) {
