...
public class ModBlocks {
    ...
    public static final ModBlockRegistry.BlockEntry<FurnitureBlock> UPRIGHT_PIANO = REGISTRY.register("upright_piano", () -> new UprightPianoBlock(Blocks.ACACIA_PLANKS, ModBlockShapes.UPRIGHT_PIANO));
